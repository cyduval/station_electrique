      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <article className="prose prose-lg dark:prose-invert">
            ...
            <p>
              Ce site est édité par [Votre nom ou raison sociale]
              <br />
            ...
            <p>
              ...
              vidéos, logos) sont protégés par le droit d&apos;auteur. Toute
            ...
            <p>
              ...
              Nous nous efforçons de maintenir des informations exactes et à
              jour, mais ne pouvons garantir l&apos;exactitude de toutes les
              informations.
            </p>
            ...
            <p className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
              <strong>
                En tant que Partenaire Amazon, ce site réalise un bénéfice sur
            ...
            <p>
              Ce site peut contenir des liens vers d&apos;autres sites. Nous
